...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoJackpotService.Data.Database.Models.Prize", b =>
                {
                    ...
                    b.Property<List<PrizeImage>>("AdditionalImages")
                        .IsRequired()
                        .HasColumnType("jsonb")
                    ...
                    b.HasIndex("WinnerTicketId")
                        .HasDatabaseName("ix_prizes_winner_ticket_id");
            ...
            modelBuilder.Entity("CryptoJackpotService.Data.Database.Models.UserReferral", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CryptoJackpotService.Data.Database.Models.Winner", b =>
                {
                    ...
                    b.HasIndex("PrizeId")
                        .HasDatabaseName("ix_winners_prize_id");
            ...
            modelBuilder.Entity("CryptoJackpotService.Data.Database.Models.Prize", b =>
                {
                    b.HasOne("CryptoJackpotService.Data.Database.Models.Lottery", "Lottery")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_prizes_lotteries_lottery_id");

                    b.HasOne("CryptoJackpotService.Data.Database.Models.Ticket", "WinnerTicket")
                        .WithMany("WonPrizes")
                        .HasForeignKey("WinnerTicketId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_prizes_tickets_winner_ticket_id");

                    b.Navigation("Lottery");

                    b.Navigation("WinnerTicket");
                });
            ...
            modelBuilder.Entity("CryptoJackpotService.Data.Database.Models.UserReferral", b =>
                {
                    b.HasOne("CryptoJackpotService.Data.Database.Models.User", "Referred")
                        .WithOne("ReferredBy")
                        .HasForeignKey("CryptoJackpotService.Data.Database.Models.UserReferral", "ReferredId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_user_referral_users_referred_id");

                    b.HasOne("CryptoJackpotService.Data.Database.Models.User", "Referrer")
                        .WithMany("Referrals")
            ...
            modelBuilder.Entity("CryptoJackpotService.Data.Database.Models.Winner", b =>
                {
                    ...
                    b.HasOne("CryptoJackpotService.Data.Database.Models.Prize", "Prize")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_winners_prizes_prize_id");

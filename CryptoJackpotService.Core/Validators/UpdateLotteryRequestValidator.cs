...
public class UpdateLotteryRequestValidator : LocalizedValidator<UpdateLotteryRequest>
{
    public UpdateLotteryRequestValidator(IStringLocalizer<ISharedResource> localizer) : base(localizer)
    {
        RuleFor(x => x.Title)
